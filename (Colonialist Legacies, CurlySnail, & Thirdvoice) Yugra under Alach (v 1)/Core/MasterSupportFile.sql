...
VALUES	('CIVILIZATION_CTCL_YUGRA',	'Yagem',	55,	77,		null,	null,	null),
		('CIVILIZATION_CTCL_YUGRA',	'Yahem',	86,	67,		null,	null,	null),
		('CIVILIZATION_CTCL_YUGRA',	'Cordiform',	47,	44,		null,	null,	null),
		('CIVILIZATION_CTCL_YUGRA',	'GreatestEarth',	76,	61,		null,	null,	null),
		('CIVILIZATION_CTCL_YUGRA',	'RussiaLarge',	39,	20,		null,	null,	null)
		;
...
SELECT	'CIVILIZATION_CTCL_YUGRA', MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_DECOLONIZATION',		 7),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_MERCENARY',				 6),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 5),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 6), --Scale of Liberal to Authoritarian.
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_LEGAL',			 4), 	
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_CULTURE',		 3),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_ECONOMIC',		 6),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 4),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_FOREIGN',		 6),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_INDUSTRY',		 5),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_MILITARY',		 4),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_REFORM_RELIGION',		 6),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_SLAVERY',				 0),
		('LEADER_JFD_SHENGZONG',	'FLAVOR_JFD_STATE_RELIGION',		 6);
...
SELECT	'CIVILIZATION_CTCL_YUGRA',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
