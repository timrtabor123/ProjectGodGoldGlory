...
INSERT INTO Civilizations_YnAEMP
		...
		('CIVILIZATION_EW_YUKAGHIR',					'EarthMk3',				97,		90,		null,	null,	null),
		('CIVILIZATION_EW_YUKAGHIR',					'RussiaLarge',			88,		46,		null,	null,	null),
		('CIVILIZATION_EW_YUKAGHIR',					'Yagem',				98,		84,		null,	null,	null),
		('CIVILIZATION_EW_YUKAGHIR',					'Yahem',				118,	72,		null,	null,	null);
...
SELECT	'CIVILIZATION_EW_YUKAGHIR', MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_DECOLONIZATION',		 8),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_MERCENARY',				 6),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 2),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 4), --Scale of Liberal to Authoritarian.
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_LEGAL',			 4), 	
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_CULTURE',		 4),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_ECONOMIC',		 4),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 7),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_FOREIGN',		 4),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_INDUSTRY',		 4),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_MILITARY',		 6),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_RELIGION',		 2),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_SLAVERY',				 1),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_STATE_RELIGION',		 1);
...
SELECT	'CIVILIZATION_EW_YUKAGHIR',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
FROM Civilization_JFD_CultureTypes WHERE CivilizationType = 'CIVILIZATION_RUSSIA';

UPDATE Civilizations 
SET SoundtrackTag = 'JFD_Polar'
WHERE Type = 'CIVILIZATION_EW_YUKAGHIR'
