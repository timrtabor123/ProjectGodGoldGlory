...
WHERE Type = 'CIVILIZATION_DMS_ERITREA'
...
VALUES	('CIVILIZATION_DMS_ERITREA',	'Cordiform',		48,	14),
		('CIVILIZATION_DMS_ERITREA',	'GreatestEarth',	62,	29),
		('CIVILIZATION_DMS_ERITREA',	'Yagem',			36,	36),
		('CIVILIZATION_DMS_ERITREA',	'Yahem',			74,	38),
		('CIVILIZATION_DMS_ERITREA',	'EarthMk3',			39,	34),
		('CIVILIZATION_DMS_ERITREA',	'AfricaLarge',		51,	49),
		('CIVILIZATION_DMS_ERITREA',	'AfriAsiaAust',		47,	50),
		('CIVILIZATION_DMS_ERITREA',	'AfriGiant',		106,92),
		('CIVILIZATION_DMS_ERITREA',	'AfriSouthEuro',	55,	41),
		('CIVILIZATION_DMS_ERITREA',	'IndianOcean',		11,	54);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_DMS_ERITREA', MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
INSERT INTO JFD_Civilopedia_HideFromPedia
		(Type)
VALUES	('BUILDING_DMS_CABLEWAY_STATION_EXTRA_PRODUCTION'),
		('BUILDING_DMS_ASKARI_EXTRA_PRODUCTION');
--------------------------------------------------------------------------------------------------------------------------
-- LEADER FLAVOURS
--------------------------------------------------------------------------------------------------------------------------	
...
VALUES	('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_DECOLONIZATION',		 6),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_MERCENARY',				 6),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 4),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 4), --Scale of Liberal to Authoritarian.
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_LEGAL',			 6), 	
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_CULTURE',		 4),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_ECONOMIC',		 6),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 5),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_FOREIGN',		 7),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_INDUSTRY',		 6),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_MILITARY',		 6),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_REFORM_RELIGION',		 5),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_SLAVERY',				 2),
		('LEADER_DMS_HAMID_IDRIS_AWATE',	'FLAVOR_JFD_STATE_RELIGION',		 4);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_DMS_ERITREA',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
FROM Civilization_JFD_CultureTypes WHERE CivilizationType = 'CIVILIZATION_ETHIOPIA';
--==========================================================================================================================		
--==========================================================================================================================	