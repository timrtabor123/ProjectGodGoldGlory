...
SELECT	'ART_DEF_UNIT__WORKER_MEDIEVAL',	DamageStates, 	Formation,	'JFD_WORKFORCES_UNIT_ATLAS', 0
FROM ArtDefine_UnitInfos WHERE Type = 'ART_DEF_UNIT__WORKER';

UPDATE ArtDefine_UnitInfos 
SET IconAtlas = 'JFD_WORKFORCES_UNIT_ATLAS', PortraitIndex = 0 
...
VALUES	('JFD_WORKFORCES_UNIT_ATLAS', 	256, 		'JFD_Workforces_UnitAtlas_256.dds',	1, 				1),
		('JFD_WORKFORCES_UNIT_ATLAS', 	128, 		'JFD_Workforces_UnitAtlas_128.dds',	1, 				1),
		('JFD_WORKFORCES_UNIT_ATLAS', 	80, 		'JFD_Workforces_UnitAtlas_80.dds',	1, 				1),
		('JFD_WORKFORCES_UNIT_ATLAS', 	64, 		'JFD_Workforces_UnitAtlas_64.dds',	1, 				1),
		('JFD_WORKFORCES_UNIT_ATLAS', 	45, 		'JFD_Workforces_UnitAtlas_45.dds',	1, 				1),
		('JFD_WORKFORCES_UNIT_ATLAS', 	32, 		'JFD_Workforces_UnitAtlas_32.dds',	1, 				1);
--==========================================================================================================================
--==========================================================================================================================