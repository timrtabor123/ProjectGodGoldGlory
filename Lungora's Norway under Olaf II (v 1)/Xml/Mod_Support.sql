...
INSERT INTO Civilizations_YagemStartPosition
		(Type,							X,		Y)
VALUES	('CIVILIZATION_LUNGNORWAY',			20,		85);
-------------------------------------
...
SELECT	'CIVILIZATION_LUNGNORWAY',	Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('CIVILIZATION_LUNGNORWAY', 			null,			'JFD_Germanic'),
		('CIVILIZATION_LUNGNORWAY', 			null,			'JFD_Germanic'),
		('CIVILIZATION_LUNGNORWAY', 			null,			null),
		('CIVILIZATION_LUNGNORWAY', 			null,			null),
		('CIVILIZATION_LUNGNORWAY', 			null,			null),
		('CIVILIZATION_LUNGNORWAY', 			null,			null),
		('CIVILIZATION_LUNGNORWAY', 			null,			null);
...
VALUES	('LEADER_LUNG_OLAFII',		'FLAVOR_JFD_DECOLONIZATION',	9);
--==========================================================	
-- PROVINCES 
--==========================================================	
...
*/	
--This is an example of support which copies all attributes from an existing civ (i.e. Denmark). For the most part, this is probably all you'll need; just change 'CIVILIZATION_LUNGNORWAY' to the
--tag of your custom civ. 
INSERT INTO Civilization_JFD_ProvinceTitles
		(CivilizationType,			DefaultTitle, UniqueTitle, UseAdjective)
SELECT	'CIVILIZATION_LUNGNORWAY',	DefaultTitle, UniqueTitle, UseAdjective
...
INSERT INTO Leader_Flavors
		(LeaderType,			FlavorType,					Flavor)
VALUES	('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_SLAVERY',		7);
--==========================================================================================================================
...
SELECT	'CIVILIZATION_LUNGNORWAY',	ArtDefineTag, CultureType, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
FROM Civilization_JFD_CultureTypes WHERE CivilizationType = 'CIVILIZATION_DENMARK';

UPDATE Civilizations 
SET SoundtrackTag = 'JFD_Central'
WHERE Type = 'CIVILIZATION_LUNGNORWAY'
...
INSERT INTO Leader_Flavors
		(LeaderType,				FlavorType,					Flavor)
VALUES	('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_MERCENARY',			5);
--==========================================================================================================================	
...
INSERT INTO Leader_Flavors
		(LeaderType,			FlavorType,								Flavor)
VALUES	('LEADER_LUNG_OLAFII',		'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',		8),
		('LEADER_LUNG_OLAFII',		'FLAVOR_JFD_STATE_RELIGION',			8);
--==========================================================	
-- PROSPERITY
--==========================================================
...
SELECT	'CIVILIZATION_LUNGNORWAY',	CurrencyType
...
VALUES	('CIVILIZATION_LUNGNORWAY',	'TXT_KEY_JFD_LEGISLATURE_NAME_CIVILIZATION_DENMARK', 	'TXT_KEY_JFD_HEAD_OF_GOVERNMENT_TITLE_CIVILIZATION_DENMARK', 	'GOVERNMENT_JFD_MONARCHY', 		70);
------------------------------------------------------------	
...
VALUES  ('CIVILIZATION_LUNGNORWAY',		'TXT_KEY_JFD_HEAD_OF_GOVERNMENT_TITLE_CIVILIZATION_DENMARK_1');
------------------------------------------------------------
...
VALUES	('CIVILIZATION_LUNGNORWAY',	'TXT_KEY_GOVERNMENT_JFD_TRIBE_TITLE_LEADER',	'TXT_KEY_GOVERNMENT_JFD_TRIBE_TITLE_LEADER_DENMARK');
------------------------------------------------------------
...
VALUES	('CIVILIZATION_LUNGNORWAY',	'PARTY_JFD_REVOLUTIONARY',	'TXT_KEY_JFD_PARTY_JFD_REVOLUTIONARY_DENMARK');
------------------------------------------------------------
-- Flavors
------------------------------------------------------------	
INSERT OR REPLACE INTO Flavors 
...
INSERT INTO Leader_Flavors
		(LeaderType,			FlavorType,							Flavor)
VALUES	('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_GOVERNMENT',		6),
		('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_LEGAL',			5),
		('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_CULTURE',		8),
		('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_ECONOMIC',		4),
		('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_FOREIGN',		4),
		('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_INDUSTRY',		7),
		('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_MILITARY',		10),
		('LEADER_LUNG_OLAFII',	'FLAVOR_JFD_REFORM_RELIGION',		10);
