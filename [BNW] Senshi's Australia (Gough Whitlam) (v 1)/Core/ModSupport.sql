...
VALUES	('CIVILIZATION_SENSHI_WHITLAM',	'Cordiform',		74,	9),
		('CIVILIZATION_SENSHI_WHITLAM',	'GreatestEarth',	100, 2),
		('CIVILIZATION_SENSHI_WHITLAM',	'Yagem',			102, 10),
		('CIVILIZATION_SENSHI_WHITLAM',	'Yahem',			117, 12),
		('CIVILIZATION_SENSHI_WHITLAM',	'AfriAsiaAust',		125, 6),
		('CIVILIZATION_SENSHI_WHITLAM',	'AustralasiaGiant',	83, 26),
		('CIVILIZATION_SENSHI_WHITLAM',	'Pacific',			48,	6),
		('CIVILIZATION_SENSHI_WHITLAM',	'SouthPacificGiant',	14, 9);
--------------------------------------------------------------------------------------------------------------------------
-- Civilizations_YagemRequestedResource
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO Civilizations_YnAEMPRequestedResources
		(CivilizationType, 					MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4)
SELECT	'CIVILIZATION_SENSHI_WHITLAM',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_DECOLONIZATION',		 1),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_MERCENARY',				 4),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 0),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 2), --Scale of Liberal to Authoritarian.
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_LEGAL',			 2), 	
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_CULTURE',		 1),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_ECONOMIC',		 7),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 1),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_FOREIGN',		 3),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_INDUSTRY',		 6),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_MILITARY',		 5),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_REFORM_RELIGION',		 2),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_SLAVERY',				 0),
		('LEADER_SENSHI_WHITLAM',	'FLAVOR_JFD_STATE_RELIGION',		 0);

CREATE TABLE IF NOT EXISTS Civilization_JFD_Governments(CivilizationType text, CultureType text, LegislatureName text, OfficeTitle text, GovernmentType text, Weight integer);

INSERT INTO Civilization_JFD_Governments
		(CivilizationType, 					GovernmentType,					Weight)
VALUES	('CIVILIZATION_SENSHI_WHITLAM', 	'GOVERNMENT_JFD_REPUBLIC',		40);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_SENSHI_WHITLAM',	ArtDefineTag, CultureType,	SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, 'AS2D_SOUND_JFD_ENGLISH'
